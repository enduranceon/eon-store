-- Reintrodução da migration 20260909142732, desta vez publicada JUNTO com a
-- edge function api-v1 que já envia "value" em cada parcela (e não sozinha,
-- como da primeira vez -- o que quebrou o pagamento manual em produção
-- porque a edge function antiga ainda mandava parcelas sem "value").
--
-- Conteúdo idêntico ao da migration original; o CREATE OR REPLACE é
-- idempotente, então isso apenas reafirma o estado correto após o
-- rollback de emergência (20260909202427).
