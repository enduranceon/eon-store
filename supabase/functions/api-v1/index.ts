...
Deno.serve(async (req: Request) => {
  ...
  const refundsResponse = await handleRefundsRequest(
    req,
    path,
    serviceClient,
    gate.userId!,
  );
  if (refundsResponse) return refundsResponse;
  ...
  const contractBillingResponse = await handleContractBillingRequest(
    req,
    path,
    serviceClient,
    gate.userId!,
